...
class JackCompiler:
    ...
    def __init__(self, jack_input):
        """
        constructor of jack compiler object
    ...
    def handle_directory(self):
        """
        --------------------------------------------------
        WE WILL CREATE ONE .VM FILE FOR EVERY .JACK FILE
    ...
    def handle_file(self):
        """
        --------------------------------------------------------------
        WE WILL CREATE ONE .VM FILE FOR OUR .JACK FILE NAME file_name
...
def main():
    ...
    if os.path.isdir(file_name):
        ...
        jack_compiler = JackCompiler(folder_name)
        jack_compiler.handle_directory()
    elif file_name.endswith('.jack'):
        # its a jack file name
        jack_compiler = JackCompiler(file_name)
        jack_compiler.handle_file()
    else:
